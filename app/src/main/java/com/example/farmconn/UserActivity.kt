...
class UserActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(oldUser!=null){
            ...
            edit_User_AU.setOnClickListener{
                ...
                val surname:String
                surname=findViewById<EditText>(R.id.surname_EDITTEXT_AU).getText().toString().trim()
                ...
                passConfirm=findViewById<EditText>(R.id.passTwo_EDITTEXT_AU).getText().toString().trim()
    ...
    fun putData(user: User){
        ...
        findViewById<EditText>(R.id.name_EDITTEXT_AU).text= Editable.Factory.getInstance().newEditable(user.nameUser)
        findViewById<EditText>(R.id.surname_EDITTEXT_AU).text=Editable.Factory.getInstance().newEditable(user.secondNameUser)
        findViewById<EditText>(R.id.email_EditText_AU).text=Editable.Factory.getInstance().newEditable(user.emailUser)
        findViewById<EditText>(R.id.location_EditText_AU).text=Editable.Factory.getInstance().newEditable(
