...
class FieldEditActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        edtData.setOnClickListener{
            ...
            nameOfField= findViewById<EditText>(R.id.editTextName_ActivityFieldEdit).text.toString()
            val descriptionOfField:String
            descriptionOfField= findViewById<EditText>(R.id.editTextMultlineDescriptioneditTextName_ActivityFieldEdit).text.toString()
            val xOfField:String
            ...
            if(nameOfField!=null && descriptionOfField!=null && x!=null && y!=null ){
                ...
                if(status > 0){
                    Toast.makeText(applicationContext,"Zaktualizowano Dane",Toast.LENGTH_SHORT).show()
